...
if(isset($_POST) && !empty($_POST)){
	...
	if($_POST['form_type'] == 'contact'){
		...
		$sendMessage = "<p>Hello,</p><p>".$first_name." has sent a message having </p><p><b>Subject:</b> ".$subject."</p><p><b>Email id:</b> ".$email."</p><p><b>Query is:</b> ".$message."</p>";
	...
	if($sendMessage != ''){
		$fromEmail = $email;
		$toEmail = 'support@realdealindividual.com';
